    ...
    return (
        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight sm:text-5xl md:text-6xl flex flex-col gap-4">
                    <span className="block xl:inline text-gray-800 font-extrabold">Welcom to . .<br/></span>{' '}
                    <span className={`block text-orange-500 xl:inline font-extrabold`}>
                            Schedule Huflit
                    </span>
                </h1>
                <p className="mt-3 text-indent text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0" style={{ textIndent: '1.5rem' }}>
                    Quản lý lịch học của bạn tại HUFLIT một cách dễ dàng, nhanh chóng và hiệu quả. Hãy để chúng tôi đồng
                    hành cùng bạn trên hành trình học tập!
                </p>

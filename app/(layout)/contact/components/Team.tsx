...
import {FaGithub, FaLinkedin, FaFacebook, FaUserGraduate} from 'react-icons/fa';
...
const Team: React.FC = () => {
    return (
        <Container size="xl" className="py-16 relative">
            ...
            >
                <Title order={2} className="text-4xl font-bold text-center mb-6 flex items-center justify-center gap-3">
                ...
                <p className="text-center text-gray-500 mb-12 max-w-4xl mx-auto text-lg">
                    Chúng tôi là 2 sinh viên đam mê công nghệ, mong muốn tạo ra những giải pháp hữu ích cho cộng
                    đồng.

...
const faqData = [
  {
    question: 'Website Xếp lịch học HUFLIT có phải là trang chính thức của trường không?',
    answer: 'Không, đây là một dự án được phát triển bởi sinh viên HUFLIT với mục đích hỗ trợ cộng đồng. Website hoạt động độc lập và không phải là trang chính thức của trường.',
  ...
  },
  {
    ...
    answer: 'Bạn có thể liên hệ với chúng tôi thông qua form liên hệ trên trang Contact hoặc gửi email trực tiếp đến địa chỉ tuanmeo980provip@gmail.com. Chúng tôi sẽ phản hồi và hỗ trợ bạn trong thời gian sớm nhất.',
    icon: IconHeadset,
    image: '/images/H2.png'
  },
  {
        ...
        <Grid.Col span={{ base: 12, md: 5 }}>
          ...
          >
            <div className="relative h-[600px] rounded-2xl overflow-hidden shadow-xl">
              <Image
                src={activeIndex !== null ? faqData[activeIndex].image : '/images/Tuan&Shu01.png'}

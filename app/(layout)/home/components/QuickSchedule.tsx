...
const QuickSchedule = () => {
    return (
        <div
            className="relative w-full bg-white p-6 rounded-xl shadow-lg shadow-gray-200/50 border-t-4 border-orange-500 overflow-hidden transform hover:shadow-xl transition-all duration-300">
            {/* Background Image */}

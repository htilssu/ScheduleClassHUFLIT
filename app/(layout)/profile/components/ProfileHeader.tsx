...
import {Avatar, Text, Group, Stack, Title, Badge, ActionIcon, Tooltip, FileButton, rem, Alert} from '@mantine/core';
import { Camera, Share2, Download } from 'lucide-react';
import { updateImageUserProfile } from '@/app/actions/user-actions';

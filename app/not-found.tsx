...
export default function NotFound() {
  ...
  const fullText =
    "Có vẻ như bạn đã lạc đường. Đừng lo, chúng tôi sẽ đưa bạn về nhà!";
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-2xl w-full p-8 text-center transform transition-all duration-300">
        ...
        <h1 className="text-6xl font-extrabold mb-4 flex items-center justify-center gap-1 animate-pulse">
          <span className="text-transparent bg-clip-text bg-linear-to-r from-orange-700 to-orange-600">
            4
          </span>
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="xl:w-8 xl:h-8 w-12 h-12 flex items-center justify-center bg-orange-100 text-orange-600 rounded-full font-bold xl:text-sm text-lg">
            {countdown}
          </span>
        </div>

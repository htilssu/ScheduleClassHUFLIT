...
const Footer = () => {
    return (
        <footer className="py-10 text-white relative bg-gray-800 shadow-lg">
                        ...
                        <ul className="space-y-2">
                            {["Thỏa thuận người dùng", "Quyền riêng tư", "Quy định - chính sách"].map((item) => (
                                <li key={item}>
                                    <a
                                        href="#"
                                        className="flex items-center text-gray-300 hover:text-orange-400 transition duration-300 transform hover:translate-x-1"
                                    >
                ...
                <div className="mt-2 md:mt-4 text-center">
                    ...
                    <div className="flex md:mt-4 mt-2 justify-center space-x-6">
                        <a
                            ...
                            className="text-gray-300 hover:text-orange-400 transition duration-300 transform hover:scale-110"
                        >
                            <FaFacebookF size={24}/>
                        </a>
                        <a
